window.onload = function () {
    ...
    ////在main3模块中，点击“新建”这个id为clNew的控件时，cNew模块出现，cList模块隐藏
    //var clbNew = document.getElementById('clbNew');
    //var cList = document.getElementById('cList');
    //var cNew = document.getElementById('cNew');
    //var main3title = document.getElementById('Label5');
    //clbNew.onclick = function () {
    //    cList.style.display = 'none';
    //    cNew.style.display = 'block';
    //    main3title.innerHTML = "新建申请";
    //}

    ////main3模块中，点击“返回”这个id为clBack的控件时，cNew模块隐藏，cList模块显示
    //var clbBack = document.getElementById('clbBack');
    //clbBack.onclick = function () {
    //    cList.style.display = 'block';
    //    cNew.style.display = 'none';
    //    main3title.innerHTML = "申请记录";
    //}
